...
const FHIR: React.FC = () => {
  return (
    <Container>
      <h2 className='mt-2'>Vantagens do FHIR</h2>
      <h4 className='mt-5'>Indicação do problema:</h4>
        <p>
      ...
      <h4 className='mt-3'>Apresentação da solução:</h4>
        <p>
      ...
      <h4 className='mt-3'>Front-end desenvolvido:</h4>
        <p>
      ...
      <h4 className='mt-3'>Consumo de dados FHIR:</h4>
        <p>
      ...
      <h4 className='mt-3'>Back-end desenvolvido:</h4>
        <p>
